            ...
            <>
              ...
              <div className="card-template__bottom">
                ...
                {card.advantages.map((adv, index) => (
                  <div
                    key={adv.title + index}
                    className="card-template__bottom_advatage-column"
                  >
                    <div className="card-template__bottom_advatage-column__top">
                      ...
                      />
                      <p className="card-template__bottom_advatage-column__top_text">
                        {adv.title}
                      </p>
                    </div>
                    {adv.descriptions?.map((desc) => (
                      <p
                        key={desc}
                        className="card-template__bottom_advatage-column_text"
                      >
                        {desc}
                      </p>
                    ))}
