                        ...
                        <>
                            ...
                            <div className="card-template-green__bottom fix-bottom-height">
                                ...
                                {card.advantages.map((adv, index) => (
                                    <div key={adv.title + index} className="card-template-green__bottom_advatage-column">
                                        <div className="card-template-green__bottom_advatage-column__top">
                                            ...
                                            />
                                            <p className="card-template-green__bottom_advatage-column__top_text">{adv.title}</p>
                                        </div>
