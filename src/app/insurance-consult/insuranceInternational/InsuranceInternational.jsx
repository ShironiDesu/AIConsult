...
export default function InsuranceInternational() {
        ...
        },
        {
            ...
            advantages: [
                ...
                },
                {
                    ...
                    descriptions: ["— Подача документов в банк.", "— Отслеживание процесса рассмотрения.", "— Ведение переписки с банковскими специалистами."],
                },
                {
    ...
    const descBlackTemplate = [
        "Специализированные условия страхования",
        "Взаимодействие с несколькими страховщиками",
        "Высокая комиссия (1-3% от суммы)",
    ];
                                ...
                                {card.advantages.map((adv, index) => (
                                    ...
                                    >
                                        ...
                                        {adv.descriptions?.map((desc) => (
                                            <p key={desc} className="card-template-gray__bottom_advatage-column_text">
                                                {desc}
                                            </p>
                                        ))}
                                    </div>
