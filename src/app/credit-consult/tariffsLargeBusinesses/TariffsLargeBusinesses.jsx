...
export default function TariffsLargeBusinesses() {
  const cardsInfoArr = [
    ...
    },
    {
      ...
      advantages: ["Индивидуально, полное сопровождение <br/> под ключ"],
    },
  ];
    ...
    <div className="tariffs-large">
      ...
      <div className="tariffs-large__cards">
        {cardsInfoArr.map((card) => (
          <CardTemplate
            key={card.title}
            isChangedHeight={card.changedHeight}
            isGreen={true}
            isGray={false}
          >
            <>
                ...
                <div className="card-template-green__top_list">
                  {card.descriptions.map((desc) => (
                    <p
                      ...
                      className="card-template-green__top_list_desc"
                    />
                  ))}
                </div>
              </div>
              <div className="card-template-green__bottom">
                {card.advantages.map((adv) => (
                  <div
                    key={adv}
                    className="card-template-green__bottom_advatage"
                  >
                    <Image
                    ...
                    <p
                      ...
                      className="card-template-green__bottom_advatage_text"
                    />
                  </div>
                ))}
              </div>
